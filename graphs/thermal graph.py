...
legend2 = ax.legend(nmf[::], lblf, title="暴露人员烧伤等级", ncol=1, loc="upper right")
ax.set_title("光冲量 （卡/平方厘米）")

ax.set_xlabel("投影距离（千米）")
fig.suptitle("{:.0f}千吨当量空爆-{:.0f}公里能见度".format(Y, vis / 1000), fontsize="x-large")
